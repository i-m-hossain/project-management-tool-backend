...
'sanctum.csrf-cookie','tasks.index','tasks.store','tasks.show','tasks.update',
'tasks.destroy','projects.index','projects.store','projects.show',
'projects.update','projects.destroy','storage.local',);
